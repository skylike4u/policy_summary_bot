...
※ 목적 : 부산광역시 및 중앙부처, 그 외 공공기관/기타기관의 의미있는 정책정보를 수집하고 관계자들에게 적시성있게 공유하여 부산시 정책발전에 기여하려 함.
※ 기사 간 내용이 비슷할 경우, 중복 요약을 피하고 가장 정보가 구체적이고 유용한 기사만 선택해 요약해줘.
※ 기사에 없거나 불확실한 기관/문의처 등은 생략해.
...
### 🏢 발신기관 또는 주최기관
※ 기사 내 명확하게 발신기관/주최기관이 언급된 경우에만 작성할 것.
※ 명확한 기관명이 없는 경우는 '없음' 또는 해당 항목을 생략할 것.
※ 기사에 존재하지 않는 기관명을 절대 추론하여 작성하지 말 것 (예: '부산광역시', '부산경제진흥원' 등).
※ 전화번호, 이메일 등 기사에 연락처가 명시된 경우만 작성. 없으면 생략.
